...
$(function () {
    ...
    * */
    ...
    tic_mark.forEach(function (m, i, a) {
        ...
        CM["set" + m.toUpperCase()] = function (amount) {
            ...
            if (full) {
                if (!a[i-1]) {
                    ...
                    CM["set" + a[i-1].toUpperCase()].call(this, full);
                }
            ...
            // 3. Visualizing.
            int2arr(this[m].v).forEach(function (v, i) {
